...
package ru.gb.artem.marketapril.soap.products;
...
public class GetAllProductsResponse {
    ...
    protected List<ru.gb.artem.marketapril.soap.products.Product> products;
     ...
     *
     */
    public List<ru.gb.artem.marketapril.soap.products.Product> getProducts() {
        if (products == null) {
            products = new ArrayList<ru.gb.artem.marketapril.soap.products.Product>();
        }
